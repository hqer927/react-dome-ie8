	...
	var ProductPackageAdd = function (_React$Component) {
	    ...
	    ProductPackageAdd.prototype.rule = function rule(_data) {
	        ...
	        var _loop = function _loop(i) {
	            if (newData.eaName.v === window.productPackagePageData.feeModes.listRule[i].eaName) {
	                newData.feeModes.a.map(function (item) {
	                    if (window.productPackagePageData.feeModes.listRule[i].result.find(function (n) {
	                        return n === item.v;
	                    })) {
	        ...
	        for (var i = 0; i < window.productPackagePageData.feeModes.listRule.length; i++) {
	            var _ret = _loop(i);
	        ...
	        for (var _i2 = 0; _i2 < window.productPackagePageData.amount.showRule.length; _i2++) {
	            if (newData.feeTypes.v === window.productPackagePageData.amount.showRule[_i2].feeTypes) {
	                newShow.amount = window.productPackagePageData.amount.showRule[_i2].result;
	                break;
	            }
	        }
	        for (var _i3 = 0; _i3 < window.productPackagePageData.price.showRule.length; _i3++) {
	            if (newData.feeTypes.v === window.productPackagePageData.price.showRule[_i3].feeTypes) {
	                newShow.price = window.productPackagePageData.price.showRule[_i3].result;
	                break;
	            }
	        }
	        for (var _i4 = 0; _i4 < window.productPackagePageData.ladderPrice.showRule.length; _i4++) {
	            if (newData.feeTypes.v === window.productPackagePageData.ladderPrice.showRule[_i4].feeTypes) {
	                newShow.ladderPrice = window.productPackagePageData.ladderPrice.showRule[_i4].result;
	                break;
	            }
	        }
	        var newUnit = {
	        ...
	        for (var _i5 = 0; _i5 < window.productPackagePageData.amount.unitRule.length; _i5++) {
	            if (newData.feeTypes.v === window.productPackagePageData.amount.unitRule[_i5].feeTypes && newData.feeModes.v === window.productPackagePageData.amount.unitRule[_i5].feeModes) {
	                newUnit.amount = window.productPackagePageData.amount.unitRule[_i5].result;
	                break;
	            }
	        }
	        for (var _i6 = 0; _i6 < window.productPackagePageData.price.unitRule.length; _i6++) {
	            if (newData.feeTypes.v === window.productPackagePageData.price.unitRule[_i6].feeTypes && newData.feeModes.v === window.productPackagePageData.price.unitRule[_i6].feeModes) {
	                newUnit.price = window.productPackagePageData.price.unitRule[_i6].result;
	                break;
	            }
	        }
	        for (var _i7 = 0; _i7 < window.productPackagePageData.ladderPrice.unitRule.length; _i7++) {
	            if (newData.feeTypes.v === window.productPackagePageData.ladderPrice.unitRule[_i7].feeTypes && newData.feeModes.v === window.productPackagePageData.ladderPrice.unitRule[_i7].feeModes) {
	                newUnit.ladderPrice = window.productPackagePageData.ladderPrice.unitRule[_i7].result;
	                break;
	            }
	        }
	    ...
	    ProductPackageAdd.prototype.render = function render() {
	        ...
	        return React.createElement(
	            ...
	            this.state.show.amount ? React.createElement(
	                ...
	                React.createElement(UIInput, { type: 'positiveInt', className: 'inputBtn', maxValue: window.productPackagePageData.amount.maxValue, maxLength: window.productPackagePageData.amount.maxLength, placeholder: window.productPackagePageData.amount.placeholder, v: this.state.data.amount, onBlur: this.returnAmountValue }),
	                React.createElement(
	                    'span',
	                    null,
