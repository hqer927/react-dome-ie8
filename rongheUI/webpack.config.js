...
module.exports = {
    entry: {
        ...
        componentUI:[
            ...
            `${__dirname}/componentUI/js/CheckBox.js`,
            `${__dirname}/componentUI/js/RadioBtn.js`,
            `${__dirname}/componentUI/js/DropDownInput.js`
        ],
        bindUI:[`${__dirname}/js/bindUI.js`],
        orderChooseList:[`${__dirname}/js/orderChooseList.js`] ,
        orderChooseListZj:[`${__dirname}/js/orderChooseList-zhejiang.js`] ,
        orderForPayList:[`${__dirname}/js/orderForPayList.js`],
        productPackageWebpack:[`${__dirname}/js/productPackageWebpack.js`],
        productPackageWebpackZj:[`${__dirname}/js/productPackageWebpack-zhejiang.js`]
    },
    output: {
        path: `${__dirname}/dist/`,
        filename: '[name].js',
