...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Header = __webpack_require__(306);
	var HeaderLogin = __webpack_require__(359);
	var Footer = __webpack_require__(360);
	
	var checkUserInfo = function checkUserInfo(nextState, replace, callback) {
	    if (!window.GLOBAL.isLogin || !window.GLOBAL.userId) {
	        replace('/login');
	    }
	    callback();
	};
	        ...
	        React.createElement(Route, { path: 'login',
	            getComponents: function getComponents(nextState, callback) {
	                __webpack_require__.e/* nsure */(1, function (require) {
	                    callback(null, { header: HeaderLogin, footer: Footer, middle: __webpack_require__(361) });
	                });
	            } }),
	        React.createElement(Route, { path: 'index',
	            getComponents: function getComponents(nextState, callback) {
	                __webpack_require__.e/* nsure */(2, function (require) {
	                    callback(null, { header: Header, footer: Footer, middle: __webpack_require__(549) });
	                });
	            } }),
	        React.createElement(Route, { path: 'about',
	            getComponents: function getComponents(nextState, callback) {
	                __webpack_require__.e/* nsure */(3, function (require) {
	                    callback(null, { header: Header, footer: Footer, middle: __webpack_require__(550) });
	                });
	            } }),
	        React.createElement(
	            Route,
	            { path: 'workBench',
	                getComponents: function getComponents(nextState, callback) {
	                    __webpack_require__.e/* nsure */(4, function (require) {
	                        callback(null, { header: Header, footer: Footer, middle: __webpack_require__(551) });
	                    });
	                } },
	            React.createElement(IndexRedirect, { to: '/workBench/myServer' }),
	            React.createElement(Route, { path: 'myServer', onEnter: checkUserInfo,
	                getComponent: function getComponent(nextState, callback) {
	                    __webpack_require__.e/* nsure */(5, function (require) {
	                        callback(null, __webpack_require__(553));
	                    });
	                } }),
	            React.createElement(Route, { path: 'myApps', onEnter: checkUserInfo,
	                getComponent: function getComponent(nextState, callback) {
	                    __webpack_require__.e/* nsure */(6, function (require) {
	                        callback(null, __webpack_require__(554));
	                    });
	                } })
	        )
	    )
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var hashHistory = __webpack_require__(168).hashHistory;
	var Reflux = __webpack_require__(313);
	var ReactMixin = __webpack_require__(332);
	var storeHeader = __webpack_require__(335);
	var actionHeader = __webpack_require__(358);
	var Fetch = __webpack_require__(357);
	
	var header = window.GLOBAL.pageData.header;
	    ...
	    Header.prototype.logout = function logout() {
	        ...
	        Fetch.set(header.rightMenu.userName.action, {
	            ...
	            if (r.code && r.isExit) {
	                ...
	                var newData = _Object$assign({}, _this2.state.data);
	                newData.isLogin = 0;
	                newData.name = '';
	                newData.unReadMail = '';
	    ...
	    Header.prototype.render = function render() {
	        ...
	        return React.createElement(
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    Link,
	                    { className: 'logoBtn', to: '/index' },
	                    header.logo.img ? React.createElement('img', { src: header.logo.img, className: 'logoImg' }) : '',
	                    header.logo.text ? React.createElement(
	                        'span',
	                        null,
	                        header.logo.text
	                    ) : ''
	                ...
	                this.state.isLogin ? React.createElement(
	                    ...
	                    header.centerMenu.loginNav.map(function (item, i) {
	                        return header.centerMenu[item] && header.centerMenu[item].child && header.centerMenu[item].child.length ? React.createElement(
	                            'li',
	                            { key: i, className: _this3.state.data.navSelect === item ? 'navItem select' : 'navItem' },
	                            React.createElement(
	                                'span',
	                                { className: 'navTitle' },
	                                header.centerMenu[item].text
	                            ),
	                            React.createElement(
	                                'ul',
	                                { className: 'showMenuBox ' + item },
	                                header.centerMenu[item].child.map(function (cItem, j) {
	                                    return cItem && cItem.child && cItem.child.length ? React.createElement(
	                                        'li',
	                                        { key: j, className: 'showMenuItem' },
	                                        React.createElement(
	                                            'span',
	                                            { className: 'showMenuItemTitle' },
	                                            cItem.text
	                                        ),
	                                        React.createElement(
	                                            'ul',
	                                            { className: 'menu' },
	                                            cItem.child.map(function (iItem, n) {
	                                                return React.createElement(
	                                                    'li',
	                                                    { key: n },
	                                                    React.createElement(
	                    ...
	                    'ul',
	                    { className: 'centerMenu' },
	                    header.centerMenu.unLoginNav.map(function (item, i) {
	                        return header.centerMenu[item] && header.centerMenu[item].child && header.centerMenu[item].child.length ? React.createElement(
	                            'li',
	                            { key: i, className: _this3.state.data.navSelect === item ? 'navItem select' : 'navItem' },
	                            React.createElement(
	                ...
	                this.state.isLogin ? React.createElement(
	                    ...
	                    React.createElement(
	                        ...
	                        React.createElement(
	                            'div',
	                            { className: 'iconTips', onClick: this.logout },
	                            '\u9000\u51FA'
	                        )
	                    ),
	                    React.createElement(
	                        Link,
	                        { to: header.rightMenu.email.url },
	                        React.createElement('div', { className: this.state.data.unReadMail ? 'icon icon-emailGraySmall redDot' : 'icon icon-emailGraySmall' })
	                    )
	                ) : React.createElement(
	                    'div',
	                    { className: 'rightMenu' },
	                    header.rightMenu.unLoginBtns.map(function (item, i) {
	                        return React.createElement(
	                            Link,
	                            { key: i, role: 'button', className: item.key, to: item.url },
	                            item.text
	                        );
	                    })
	                )
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Promise = __webpack_require__(336)['default'];
	...
	module.exports = Reflux.createStore({
	    ...
	    onGetUserInfo: function onGetUserInfo() {
	        ...
	        var userInfo = new _Promise(function (resolve) {
	            Fetch.set(header.action, {
	                ...
	                if (r.code) {
	                    ...
	                    var newData = _Object$assign({}, _this.data);
	        ...
	        userInfo.then(function (_obj) {
	            return new _Promise(function (resolve) {
	                Fetch.set(header.rightMenu.email.action, {
	                    ...
	                    if (r.code) {
	                        var newData = _Object$assign({}, _obj);
	    ...
	    onSetUnReadMail: function onSetUnReadMail(_num) {
	        var newData = _Object$assign({}, this.data);
	        newData.unReadMail = _num;
	        this.trigger(newData);
	    },
	    onSetNavSelect: function onSetNavSelect(_key) {
	        var newData = _Object$assign({}, this.data);
	        newData.navSelect = _key;
	        this.trigger(newData);
	    }
	});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var task = __webpack_require__(346).set;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var global = __webpack_require__(241);
	var macrotask = __webpack_require__(346).set;
...
/***/ (function(module, exports, __webpack_require__) {
	 ...
	 */
	var Reflux = __webpack_require__(313);
	module.exports = Reflux.createActions(['getData', 'getUserInfo', 'setUnReadMail', 'setNavSelect']);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(10);
	var Link = __webpack_require__(168).Link;
	var footer = window.GLOBAL.pageData.footer;
	    ...
	    Footer.prototype.render = function render() {
	        return React.createElement(
	            ...
	            React.createElement(
	                ...
	                footer.leftItems.length ? React.createElement(
	                    'ul',
	                    { className: 'leftItem' },
	                    footer.leftItems.map(function (item, i) {
	                        return item && item.url ? React.createElement(
	                            'li',
	                            { className: 'item', key: i },
	                            React.createElement(
	                                Link,
	                                { to: item.url },
	                                item && item.img ? React.createElement('img', { src: item.img, className: 'leftItemImg' }) : '',
	                                item && item.text ? React.createElement(
	                                    'span',
	                                    null,
	                                    item.text
	                                ) : ''
	                ...
	                footer.rightItems.length ? React.createElement(
	                    'ul',
	                    { className: 'rightItem' },
	                    footer.rightItems.map(function (item, i) {
	                        return item && item.url ? React.createElement(
	                            'li',
	                            { className: 'item', key: i },
	                            React.createElement(
